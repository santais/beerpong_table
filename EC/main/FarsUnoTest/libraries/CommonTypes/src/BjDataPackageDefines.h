...
enum class PackageField
{
    ...
    E_REST_REQUEST              = 0x01,//0x05,     /// REST request
    E_MODULE                    = 0x02,//0x06,     /// Target module
    E_IP_ADDR_SRC               = 0x03,//0x07,     /// Source IP Address
    E_PAYLOAD_SIZE              = 0x07,//0x0B,     /// Number of bytes in the payload
    E_PAYLOAD                   = 0x08,//0x0C,     /// Payload
    E_EOF                                   /// End of file
};
